...
def makeMove(board, letter, move):
    board[int(move[0]) -1][int(move[1]) -1] = letter
...
def getPlayerMove(board):
    ...
    move = [' ', ' ']
    while move[0] not in '0 1 2 3 4 5'.split() or move[1] not in '0 1 2 3 4 5 6'.split() or not isSpaceFree(board, move):
        move[0] = int(raw_input('What is your next ROW move? (1-6)\t')) -1
        move[1] = int(raw_input('What is your next COLUMN move? (1-7)\t')) -1
    return move
